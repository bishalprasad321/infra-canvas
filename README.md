...
### DevOps Sandbox
- Cloud Simulation: LocalStack (AWS EC2 and S3 API mock)
...
4. **Live Run & Logs Streaming**:
   - The Go backend runner runs the compiled Terraform, Ansible, and Kubernetes scripts inside the dev sandbox.
   - Deployment logs are streamed live back to the frontend client over WebSockets.
...
This starts:
- LocalStack on port 4566 (simulating AWS S3, EC2 APIs)
