...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-gradient-to-b from-slate-900 to-slate-950 border-r border-border/50 flex flex-col h-full overflow-hidden">
      {/* Header */}
      <div className="p-4 border-b border-border/50 bg-slate-900/50 backdrop-blur-sm">
                  ...
                  <div className="ml-4 space-y-2 animate-in fade-in slide-in-from-top-2 duration-200">
                    {groupedModules[category].map((module) => (
                      <div
                        ...
                        className="px-3 py-2.5 bg-slate-800/40 border border-border/50 rounded-md cursor-grab hover:cursor-grabbing hover:bg-slate-700/60 hover:border-input transition-all duration-200 group/item"
                      >
      ...
      {/* Footer Info */}
      <div className="px-4 py-3 border-t border-border/50 bg-slate-900/50 backdrop-blur-sm">
