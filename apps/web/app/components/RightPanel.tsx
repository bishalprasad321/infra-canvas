...
export default function RightPanel() {
  ...
  return (
    <aside className="w-96 bg-gradient-to-b from-slate-900/80 to-slate-950/80 border-l border-border/50 flex flex-col shrink-0 backdrop-blur-sm">
      ...
      <div className="border-b border-border/50 bg-slate-900/50">
      ...
      <div className="flex-grow overflow-hidden flex flex-col">
        {nodes.length === 0 ? (
          ...
          <div className="flex-1 overflow-y-auto p-0">
            <div className="bg-slate-950/50 border border-border/30 rounded-lg font-mono text-sm overflow-x-auto h-full flex">
              <div className="flex w-full">
                {/* Line Numbers */}
                <div className="bg-slate-900/50 border-r border-border/30 px-3 py-4 text-slate-600 text-right select-none flex-shrink-0">
                  {yamlCode.split('\n').map((_, i) => (
      ...
      {/* Footer Info */}
      <div className="px-4 py-3 border-t border-border/50 bg-slate-900/50 text-xs text-slate-500 text-center">
