...
export function TiltCard({
  ...
  return (
    <div
      ...
      className={clsx('will-change-transform relative overflow-hidden', className)}
      style={{
        transform,
        ...
        >
          <div
            ...
            style={{
              ...
              background:
                'radial-gradient(circle, rgba(99,102,241,0.12) 0%, rgba(245,158,11,0.06) 30%, transparent 60%)',
            }}
          />
        </div>
      )}
