  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/[0.06] bg-[#030712]/80 backdrop-blur-xl">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-4 lg:px-10">
        ...
        <nav className="hidden items-center gap-8 lg:flex ml-8">
          <a href="#features" className="text-sm font-medium text-muted-foreground transition hover:text-white">Features</a>
          <a href="#solutions" className="text-sm font-medium text-muted-foreground transition hover:text-white">Niches</a>
          <a href="#pricing" className="text-sm font-medium text-muted-foreground transition hover:text-white">Pricing</a>
          <a href="#docs" className="text-sm font-medium text-muted-foreground transition hover:text-white">Docs</a>
        </nav>
      ...
      {/* Mobile Menu Overlay */}
      {mobileMenuOpen && (
        <div className="absolute top-full left-0 w-full bg-[#030712] border-b border-white/[0.06] p-6 flex flex-col gap-4 md:hidden shadow-2xl animate-in fade-in slide-in-from-top-5 duration-200">
          <a href="#features" onClick={onToggleMobileMenu} className="text-sm font-medium text-muted-foreground hover:text-white py-2 border-b border-white/[0.03]">Features</a>
          <a href="#solutions" onClick={onToggleMobileMenu} className="text-sm font-medium text-muted-foreground hover:text-white py-2 border-b border-white/[0.03]">Niches</a>
          <a href="#pricing" onClick={onToggleMobileMenu} className="text-sm font-medium text-muted-foreground hover:text-white py-2 border-b border-white/[0.03]">Pricing</a>
          <a href="#docs" onClick={onToggleMobileMenu} className="text-sm font-medium text-muted-foreground hover:text-white py-2">Docs</a>
              ...
              <div className="mt-4 flex items-center gap-1.5 bg-slate-950/40 p-1 rounded-xl border border-white/[0.03] w-fit">
                {['curl', 'python', 'node'].map((tab) => (
                  <button 
                    ...
                    className={`rounded-lg px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wider transition cursor-pointer ${
                      selectedSdkTab === tab 
  ...
  return (
    <footer className="bg-[#030712] border-t border-white/[0.06] relative z-10">
      <div className="mx-auto grid w-full max-w-7xl gap-10 px-6 py-14 lg:grid-cols-12 lg:px-10">
        ...
        <div className="lg:col-span-2">
          <p className="text-xs uppercase tracking-widest text-white font-bold">Resources</p>
          <ul className="mt-4 space-y-2.5 text-xs text-muted-foreground">
            ...
            <li><span className="hover:text-white transition cursor-pointer">Localstack Sandbox Guide</span></li>
